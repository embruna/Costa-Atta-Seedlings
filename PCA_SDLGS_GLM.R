...
#GLMS
glmperc.sdlg0 = glm(sdlg.no ~ perc.cover ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.sdlg0)


glmperc.sdlg1 = glm(sdlg.no ~ nest ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.sdlg1)

glmperc.sdlg2 = glm(sdlg.no ~ location ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.sdlg2)

glmperc.sdlg3 = glm(sdlg.no ~ perc.cover+nest ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.sdlg3)

glmperc.sdlg4 = glm(sdlg.no ~ perc.cover+location ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.sdlg4)

glmperc.sdlg4.5 = glm(sdlg.no ~ nest+location ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.sdlg4.5)

glmperc.sdlg5 = glm(sdlg.no ~ perc.cover+location+nest ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
...
# glmperc.sdlg4 = glm(sdlg.no ~ perc.cover*perc.cover+nest ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
# summary(glmperc.sdlg4)
...
#ANOva of best fit model (not correct but useful at this stage)
# bestfit_sdlgno =aov(spp.no ~ nest+location ,data=NEST.DATA.PCA) #Recall * is syntax syntax shortcue of both main effects + interaction
# summary(bestfit_sdlgno)
...
glmperc.spp0 = glm(spp.no ~ perc.cover ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.spp0)

glmperc.spp1 = glm(spp.no ~ nest ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.spp1)

glmperc.spp2 = glm(spp.no ~ location ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.spp2)

glmperc.spp3 = glm(spp.no ~ perc.cover+nest ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.spp3)

glmperc.spp4 = glm(spp.no ~ perc.cover+location ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.spp4)

glmperc.spp4.5 = glm(spp.no ~ nest+location ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
summary(glmperc.spp4.5)

glmperc.spp5 = glm(spp.no ~ perc.cover+location+nest ,data=NEST.DATA.PCA,family=poisson) #Recall * is syntax syntax shortcue of both main effects + interaction
...
# #ANOva of best fit model (not correct but useful at this stage)
# bestfit_sppno =aov(spp.no ~ location ,data=NEST.DATA.PCA) #Recall * is syntax syntax shortcue of both main effects + interaction
# # summary(bestfit_sppno)
