...
g_NOsoils <- ggbiplot(nest.env.pca.nosoil, obs.scale = 1, var.scale = 1, 
  ...
  annotate ("text", x=-4.5, y=3, label="A", fotnface=
...
#############################
#############################
###PLOTS OF SEEDLING ABUNDNACE VS PCA SCORES
#############################
#############################



PCA.sdlgs.fig1<-ggplot(sdlgs.nosoil, aes(x = PCA1.nosoil, y = sdlg.no, col=location, fill=location)) + 
...
PCA.sdlgs.fig1<-PCA.sdlgs.fig1 + scale_colour_manual(values=c("darkred","orangered2", "darkblue"))  #I chose my own colors for the lines
#plot.sdlg.no<-plot.sdlg.no + scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(-10, 1400))
PCA.sdlgs.fig1<-PCA.sdlgs.fig1 + scale_x_continuous(breaks = seq(-4, 4, 2), limits = c(-4, 4))
PCA.sdlgs.fig1<- PCA.sdlgs.fig1 + theme_classic()+
...
PCA.sdlgs.fig2<-ggplot(sdlgs.nosoil, aes(x = PCA2.nosoil, y = sdlg.no, col=location, fill=location)) + 
  geom_point(shape=16, size = 3) +
  ylab("seedling abundance") +
  xlab("PCA1-2")+
  ggtitle("B")+
  #scale_colour_hue(l=50) + # Use a slightly darker palette than normal
  geom_smooth(method=lm,se=FALSE)   # Add linear regression lines
PCA.sdlgs.fig2<-PCA.sdlgs.fig2 + scale_colour_manual(values=c("darkred","orangered2", "darkblue"))  #I chose my own colors for the lines
#plot.sdlg.no<-plot.sdlg.no + scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(-10, 1400))
PCA.sdlgs.fig2<-PCA.sdlgs.fig2 + scale_x_continuous(breaks = seq(-4, 4, 2), limits = c(-4, 4))
PCA.sdlgs.fig2<- PCA.sdlgs.fig2 + theme_classic()+
  theme(plot.title = element_text(face="bold", size=18, vjust=-3, hjust=0.05),        #Sets title size, style, location
        axis.title.x=element_text(colour="black", size = 18, vjust=0),            #sets x axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.title.y=element_text(colour="black", size = 18, vjust=2),            #sets y axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.text=element_text(colour="black", size = 16),                              #sets size and style of labels on axes
...
PCA.sdlgs.fig3<-ggplot(sdlgs.all, aes(x = PCA1.all, y = sdlg.no, col=location, fill=location)) + 
  geom_point(shape=16, size = 3) +
  ylab("seedling abundance") +
  xlab("PCA2-1")+
  ggtitle("C")+
  #scale_colour_hue(l=50) + # Use a slightly darker palette than normal
  geom_smooth(method=lm,se=FALSE)   # Add linear regression lines
PCA.sdlgs.fig3<-PCA.sdlgs.fig3 + scale_colour_manual(values=c("darkred", "darkblue"))  #I chose my own colors for the lines
#plot.sdlg.no<-plot.sdlg.no + scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(-10, 1400))
PCA.sdlgs.fig3<-PCA.sdlgs.fig3 + scale_x_continuous(breaks = seq(-4, 4, 2), limits = c(-4, 4))
PCA.sdlgs.fig3<- PCA.sdlgs.fig3 + theme_classic()+
  theme(plot.title = element_text(face="bold", size=18, vjust=-3, hjust=0.05),        #Sets title size, style, location
        axis.title.x=element_text(colour="black", size = 18, vjust=0),            #sets x axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.title.y=element_text(colour="black", size = 18, vjust=2),            #sets y axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.text=element_text(colour="black", size = 16),                              #sets size and style of labels on axes
...
PCA.sdlgs.fig4<-ggplot(sdlgs.all, aes(x = PCA2.all, y = sdlg.no, col=location, fill=location)) + 
  geom_point(shape=16, size = 3) +
  ylab("seedling abundance") +
  xlab("PCA2-2")+
  ggtitle("D")+
  #scale_colour_hue(l=50) + # Use a slightly darker palette than normal
  geom_smooth(method=lm,se=FALSE)   # Add linear regression lines
PCA.sdlgs.fig4<-PCA.sdlgs.fig4 + scale_colour_manual(values=c("darkred", "darkblue"))  #I chose my own colors for the lines
#plot.sdlg.no<-plot.sdlg.no + scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(-10, 1400))
PCA.sdlgs.fig4<-PCA.sdlgs.fig4 + scale_x_continuous(breaks = seq(-4, 4, 2), limits = c(-4, 4))
PCA.sdlgs.fig4<- PCA.sdlgs.fig4 + theme_classic()+
  theme(plot.title = element_text(face="bold", size=18, vjust=-3, hjust=0.05),        #Sets title size, style, location
        axis.title.x=element_text(colour="black", size = 18, vjust=0),            #sets x axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.title.y=element_text(colour="black", size = 18, vjust=2),            #sets y axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.text=element_text(colour="black", size = 16),                              #sets size and style of labels on axes
...
#############################
#############################
###PLOTS OF SPECIeS RICHNESS VS PCA SCORES
#############################
#############################
...
PCA.spp.fig1<-ggplot(sdlgs.nosoil, aes(x = PCA1.nosoil, y = spp.no, col=location, fill=location)) + 
  geom_point(shape=16, size = 3) +
  ylab("seedling species richness") +
  xlab("PCA1-1")+
  ggtitle("A")+
  #scale_colour_hue(l=50) + # Use a slightly darker palette than normal
  geom_smooth(method=lm,se=FALSE)   # Add linear regression lines
PCA.spp.fig1<-PCA.spp.fig1 + scale_colour_manual(values=c("darkred","orangered2", "darkblue"))  #I chose my own colors for the lines
#plot.spp.no<-plot.spp.no + scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(-10, 1400))
PCA.spp.fig1<-PCA.spp.fig1 + scale_x_continuous(breaks = seq(-4, 4, 2), limits = c(-4, 4))
PCA.spp.fig1<- PCA.spp.fig1 + theme_classic()+
  theme(plot.title = element_text(face="bold", size=18, vjust=-3, hjust=0.05),        #Sets title size, style, location
        axis.title.x=element_text(colour="black", size = 18, vjust=0),            #sets x axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.title.y=element_text(colour="black", size = 18, vjust=2),            #sets y axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.text=element_text(colour="black", size = 16),                              #sets size and style of labels on axes
...
PCA.spp.fig2<-ggplot(sdlgs.nosoil, aes(x = PCA2.nosoil, y = spp.no, col=location, fill=location)) + 
  geom_point(shape=16, size = 3) +
  ylab("seedling species richness") +
  xlab("PCA1-2")+
  ggtitle("B")+
  #scale_colour_hue(l=50) + # Use a slightly darker palette than normal
  geom_smooth(method=lm,se=FALSE)   # Add linear regression lines
PCA.spp.fig2<-PCA.spp.fig2 + scale_colour_manual(values=c("darkred","orangered2", "darkblue"))  #I chose my own colors for the lines
#plot.spp.no<-plot.spp.no + scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(-10, 1400))
PCA.spp.fig2<-PCA.spp.fig2 + scale_x_continuous(breaks = seq(-4, 4, 2), limits = c(-4, 4))
PCA.spp.fig2<- PCA.spp.fig2 + theme_classic()+
  theme(plot.title = element_text(face="bold", size=18, vjust=-3, hjust=0.05),        #Sets title size, style, location
        axis.title.x=element_text(colour="black", size = 18, vjust=0),            #sets x axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.title.y=element_text(colour="black", size = 18, vjust=2),            #sets y axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.text=element_text(colour="black", size = 16),                              #sets size and style of labels on axes
...
PCA.spp.fig3<-ggplot(sdlgs.all, aes(x = PCA1.all, y = spp.no, col=location, fill=location)) + 
  geom_point(shape=16, size = 3) +
  ylab("seedling species richness") +
  xlab("PCA2-1")+
  ggtitle("C")+
  #scale_colour_hue(l=50) + # Use a slightly darker palette than normal
  geom_smooth(method=lm,se=FALSE)   # Add linear regression lines
PCA.spp.fig3<-PCA.spp.fig3 + scale_colour_manual(values=c("darkred", "darkblue"))  #I chose my own colors for the lines
#plot.spp.no<-plot.spp.no + scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(-10, 1400))
PCA.spp.fig3<-PCA.spp.fig3 + scale_x_continuous(breaks = seq(-4, 4, 2), limits = c(-4, 4))
PCA.spp.fig3<- PCA.spp.fig3 + theme_classic()+
  theme(plot.title = element_text(face="bold", size=18, vjust=-3, hjust=0.05),        #Sets title size, style, location
        axis.title.x=element_text(colour="black", size = 18, vjust=0),            #sets x axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.title.y=element_text(colour="black", size = 18, vjust=2),            #sets y axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.text=element_text(colour="black", size = 16),                              #sets size and style of labels on axes
...
PCA.spp.fig4<-ggplot(sdlgs.all, aes(x = PCA2.all, y = spp.no, col=location, fill=location)) + 
  geom_point(shape=16, size = 3) +
  ylab("seedling species richness") +
  xlab("PCA2-2")+
  ggtitle("D")+
  #scale_colour_hue(l=50) + # Use a slightly darker palette than normal
  geom_smooth(method=lm,se=FALSE)   # Add linear regression lines
PCA.spp.fig4<-PCA.spp.fig4 + scale_colour_manual(values=c("darkred", "darkblue"))  #I chose my own colors for the lines
#plot.spp.no<-plot.spp.no + scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(-10, 1400))
PCA.spp.fig4<-PCA.spp.fig4 + scale_x_continuous(breaks = seq(-4, 4, 2), limits = c(-4, 4))
PCA.spp.fig4<- PCA.spp.fig4 + theme_classic()+
  theme(plot.title = element_text(face="bold", size=18, vjust=-3, hjust=0.05),        #Sets title size, style, location
        axis.title.x=element_text(colour="black", size = 18, vjust=0),            #sets x axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.title.y=element_text(colour="black", size = 18, vjust=2),            #sets y axis title size, style, distance from axis #add , face = "bold" if you want bold
        axis.text=element_text(colour="black", size = 16),                              #sets size and style of labels on axes
